...
//  for (symbol_tablet::symbolst::iterator it = symbol_table.symbols.begin(); it != symbol_table.symbols.end(); it++)
//  {
//	  if (it->first == "c::main::1::data")
//		  it->second.is_thread_local = false;
//  }
